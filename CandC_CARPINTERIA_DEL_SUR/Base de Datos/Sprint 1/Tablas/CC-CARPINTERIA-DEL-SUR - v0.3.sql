...
-- TABLA INTERMEDIA ProveedorMaterial 
...
CREATE TABLE ProveedorMaterial (
	...
	CONSTRAINT PK_ProveedorMaterial PRIMARY KEY (id_proveedor, id_material), 
	CONSTRAINT FK_PM_Proveedor FOREIGN KEY (id_proveedor) REFERENCES Proveedor(id_proveedor), 
	CONSTRAINT FK_PM_Material FOREIGN KEY (id_material) REFERENCES Material(id_material)
);
...
EXEC sp_helpconstraint 'Material'; 
ALTER TABLE Material DROP CONSTRAINT [CK__Material__costo___59FA5E80];
ALTER TABLE Material DROP COLUMN costo_unitario;


-- ELIMINAR REGISTROS (USARLO CUANDO SEA NECESARIO) Y HACER QUE SE REINICIEN LOS ID Y NO SE VAYAN SUMANDO 
DELETE FROM ProveedorMaterial; 
DELETE FROM Categoria
DBCC CHECKIDENT ('Categoria', RESEED, 0);  -- próximo insert será id = 1
DELETE FROM DetalleCompra
DBCC CHECKIDENT ('DetalleCompra', RESEED, 0);  -- próximo insert será id = 1
DELETE FROM DetalleFabricacion
DBCC CHECKIDENT ('DetalleFabricacion', RESEED, 0);  -- próximo insert será id = 1
DELETE FROM DetallePedido
DBCC CHECKIDENT ('DetallePedido', RESEED, 0);  -- próximo insert será id = 1
DELETE FROM Domicilio
DBCC CHECKIDENT ('Domicilio', RESEED, 0);  -- próximo insert será id = 1
DELETE FROM Factura
DBCC CHECKIDENT ('Factura', RESEED, 0);  -- próximo insert será id = 1
DELETE FROM Material
DBCC CHECKIDENT ('Material', RESEED, 0);  -- próximo insert será id = 1
DELETE FROM OrdenCompra
DBCC CHECKIDENT ('OrdenCompra', RESEED, 0);  -- próximo insert será id = 1
DELETE FROM Pedido
DBCC CHECKIDENT ('Pedido', RESEED, 0);  -- próximo insert será id = 1
DELETE FROM Producto
DBCC CHECKIDENT ('Producto', RESEED, 0);  -- próximo insert será id = 1
DELETE FROM Proveedor
DBCC CHECKIDENT ('Proveedor', RESEED, 0);  -- próximo insert será id = 1


SELECT * FROM ProveedorMaterial; 
